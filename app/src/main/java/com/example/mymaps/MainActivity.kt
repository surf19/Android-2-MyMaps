...
// import com.example.mymaps.R.id.rvMaps
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // val userMapsFromFile = deSerializeUserMaps(this) --> used before line 44

        rvMaps = findViewById(R.id.rvMaps)
        // userMaps = generateSampleData().toMutableList() --> used before line 44
        // userMaps.addAll(userMapsFromFile) --> used before line 44
